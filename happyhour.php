...
<head>
   <title>Central perk coffee</title>
    <meta charset="utf-8">
    <link rel="stylesheet" href="cp1.css">
</head>
 
 
        <header><h1>Happy hours at Central Perk Coffee House</h1></header>
    ...
    <section>
        ...
        <article>
            <p style="font: italic"> Central perk cofee shop offers you happy ours only on weekends</p>
          <ol>
...
<body>
    ...
    <footer>
        Copyright &copy; 2020 Central Perk Coffee House<br>
        <a href="mailto:webmaster@centralperkch.com">Webmaster</a>
        </footer>
